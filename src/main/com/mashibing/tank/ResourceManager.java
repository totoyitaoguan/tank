...
public class ResourceManager {
    ...
    // static block is executed when ResourceManager class is loaded to memory
    static{
        try {
            ...
            for (int i = 0; i < 16; i++) {
                explosions[i] = ImageIO.read(ResourceManager.class.getClassLoader().getResourceAsStream("images/e" + (i+1) + ".gif"));
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
